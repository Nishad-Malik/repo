...
public class FamilyTree {
    ...
    private static class TreeNode {
        ...
        ArrayList<TreeNode> collectAncestorsToList() {
            ...
            //get this node
            TreeNode currTreeNode = this;

            //loop while current node has a parent 
            while(currTreeNode.parent != null)
            {
                //add parent to ancestors
                ancestors.add(currTreeNode.parent);
    ...
    private void addLine(String line) throws TreeException
    {
        ...
        if (colonIndex < 0){
            throw new TreeException("Line is missing a colon: " + line);
        }
    ...
    TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
    {
        ...
        if (node1 == null)
            throw new TreeException("Error: Name is null");
